    ...
    class PosOrderDetail extends PosComponent {
            ...
            if (debit_amount != 0) {
                ...
                if (confirmed) {
                    ...
                    let payment = {
                        ...
                        payment_method_id: parseInt(payment_val.payment_method_id),
        ...
        async addBackOrder(draft) {
            ...
            if (order.served_by_id) {
                new_order['served_by_id'] = order.served_by_id[0]
                new_order['served_by'] = this.env.pos.user_by_id[new_order['served_by_id']]
            }
            if (order.user_id && this.env.pos.user_by_id[order.user_id[0]]) {
                new_order['created_user_id'] = order.user_id[0]
            }
            this.env.pos.set('selectedOrder', new_order);
            return new_order;
        }
