...
class PosConfig(models.Model):
    ...
    maximum_ticket_display = fields.Integer("Maximum Ticket Display", default=100)
    sort_by_ticket = fields.Selection([
        ('request_time', 'Request Time'),
        ('request_time_desc', 'Request Time Descending')
    ], default='request_time', string='Sort By Request Time')
