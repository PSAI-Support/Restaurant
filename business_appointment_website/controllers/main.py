...
class CustomerPortal(CustomerPortal):
    ...
    def _reservation_details_validate(self, data, rtype_id=None):
        ...
        error = dict()
        error_message = []
        mandatory_fields, date_fields, binary_fields, bool_fields = reservation_obj._return_custom_fields(rtype_id)
        website_id = request.website
            ...
            if search_in in (field_name,):
                ...
                if field_type == "selection":
                    all_sel_values_ids = request.env["ir.model.fields.selection"].sudo().search([
                        ...
                        ("name", "ilike", search), # that's already lang-dependent
                    ])
    ...
    def public_ba_rpc(self, model, method, args):
        ...
        if model == "business.resource" and method == "action_construct_time_slots":
        ...
        elif model == "business.appointment.core" and method == "create_reservation_try":
            ...
            try:
                ...
                res = model_obj.create_reservation_try(values)
                if res:
